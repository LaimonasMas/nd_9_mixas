...
$smart5 = '<label for="a"><img src="ffe8d7c15f38e2737b18d300e93bb1ca.jpg" alt=""></label><input type="checkbox" name="checkbox[]" value="10" id="a"';
...
$landLine5 = '<label for="a"><img src="ef1784a6ccd0772768caedaf7c06f7d0.jpg" alt=""></label><input type="checkbox" name="checkbox[]" value="8" id="a"';
